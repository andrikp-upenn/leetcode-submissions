class Solution:
    def productExceptSelf(self, nums: List[int]) -> List[int]:
        ...
        """
        result = []
        #Can loop through each variable and skip the iue that we are currently at and mulitply everything else
        # Look to the left and right and multiply them together without including yourself
